...
pathToRFOutput <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_allSamples_10CV_RandomForest_2000Iter_RFData.r"

# loads sortedAllCV_meanDecreaseAcc_byOTU, sortedAllCV_meanDecreaseGini_byOTU
load(pathToRFOutput)

# loads the DESeq2 results
pathToSaveDESeq2Output <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_DESEQ2_results_allSamples.r"
...
RFFileName <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_RemnantSamples_5CV_RandomForest_2000Iter_RFData.r"

# loads sortedAllCV_meanDecreaseAcc_byOTU, sortedAllCV_meanDecreaseGini_byOTU
load(RFFileName)

# loads the DESeq2 results
DESeq2FileName <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_DESEQ2_results_remnantSites.r"
...
RFFileName <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_DisturbedSamples_5CV_RandomForest_2000Iter_RFData.r"

# loads sortedAllCV_meanDecreaseAcc_byOTU, sortedAllCV_meanDecreaseGini_byOTU
load(RFFileName)

# loads the DESeq2 results
DESeq2FileName <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/GradientCoordinated_DESEQ2_results_disturbedSites.r"
