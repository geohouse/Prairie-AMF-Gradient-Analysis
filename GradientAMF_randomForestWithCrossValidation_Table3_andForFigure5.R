...
# Working correctly 111917, but note that some of the graph labels will be incorrect for the 
# classifications of West/East using only the remnant sites or only the disturbed sites due to lack
# of input to the random forest generation function to control these labels. These labels are correct
# for the classification for Remnant/Disturbed using all samples. 
...
# Add the distGroup
binarySubsetOTUframeGradient_onlyAMFOTUsWithLabels <- cbind(distGroup, binarySubsetOTUframeGradient_onlyAMFOTUs)
...
plotFilePath <- "~/Prairie-AMF-Gradient-Analysis-master/autoGeneratedScriptOutput/"
